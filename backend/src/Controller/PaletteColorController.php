            ...
            foreach ($palette['paletteColors'] as $paletteColor) {
                ...
                $paletteColorsArray[] = [
                    ...
                    'color' => [
                        ...
                        'cielabL' => $color->getCielabL(),
                        'cielabA' => $color->getCielabA(),
                        'cielabB' => $color->getCielabB(),
                        'rgbR' => $color->getRgbR(),
                        'rgbG' => $color->getRgbG(),
                        'rgbB' => $color->getRgbB(),
                        'cmykC' => $color->getCmykC(),
                        'cmykM' => $color->getCmykM(),
                        'cmykY' => $color->getCmykY(),
                        'cmykK' => $color->getCmykK(),
                        'ceresitaName' => $color->getCeresitaName(),
