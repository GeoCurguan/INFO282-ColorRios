...
const Admin = ({ data }) => {
  ...
  const fetchVisits = async () => {
    try {
      ...
      const response = await fetch("http://127.0.0.1:8000/api/getVisitas", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchPalettes = async () => {
    try {
      ...
      const response = await fetch("http://127.0.0.1:8000/api/getPalettes", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchPalettesLR = async () => {
    try {
      ...
      const response = await fetch("http://127.0.0.1:8000/api/getPalettesLR", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
